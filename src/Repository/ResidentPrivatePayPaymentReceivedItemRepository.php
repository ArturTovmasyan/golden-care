...
/**
 * Class ResidentPrivatePayPaymentReceivedItemRepository
 * @package App\Repository
 */
class ResidentPrivatePayPaymentReceivedItemRepository extends EntityRepository implements RelatedInfoInterface
{
    /**
    ...
    {
        $queryBuilder
            ->from(ResidentPrivatePayPaymentReceivedItem::class, 'rpri')
            ->innerJoin(
