 ...
 */
class MedicalHistoryConditionRepository extends EntityRepository implements RelatedInfoInterface
{
    /**
    ...
    public function getRelatedData(Space $space = null, array $entityGrants = null, $mappedBy = null, $id = null, array $ids = null)
    {
        ...
        if ($ids !== null) {
            $qb
                ->andWhere('mhc.id IN (:ids)')
                ->setParameter('ids', $ids);
        }

        if ($mappedBy === null && $id === null && $ids === null) {
            $qb
                ->andWhere('mhc.id IN (:array)')
                ->setParameter('array', []);
        }
