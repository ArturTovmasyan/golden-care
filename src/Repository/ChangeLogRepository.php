...
class ChangeLogRepository extends EntityRepository implements RelatedInfoInterface
{
    ...
    public function search(Space $space = null, array $entityGrants = null, QueryBuilder $queryBuilder): void
    {
        $queryBuilder
            ...
            ->addSelect("JSON_UNQUOTE(JSON_EXTRACT(cl.content, '$.owner')) AS title")
            ->addSelect("JSON_UNQUOTE(JSON_EXTRACT(cl.content, '$.created_at')) AS log_time")
            ->addSelect("JSON_UNQUOTE(JSON_EXTRACT(cl.content, '$.user_name')) AS updated_by")
            ->innerJoin(
                Space::class,
                's',
                Join::WITH,
