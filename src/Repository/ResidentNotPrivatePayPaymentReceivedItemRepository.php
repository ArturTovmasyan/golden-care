...
/**
 * Class ResidentNotPrivatePayPaymentReceivedItemRepository
 * @package App\Repository
 */
class ResidentNotPrivatePayPaymentReceivedItemRepository extends EntityRepository implements RelatedInfoInterface
{
    /**
    ...
    {
        $queryBuilder
            ->from(ResidentNotPrivatePayPaymentReceivedItem::class, 'rpri')
            ->innerJoin(
