...
/**
 * Class ResidentResidentNotPrivatePayPaymentReceivedItemPaymentReceivedItem
 *
 * @ORM\Entity(repositoryClass="App\Repository\ResidentNotPrivatePayPaymentReceivedItemRepository")
 * @ORM\Table(name="tbl_resident_not_private_pay_payment_received_item")
 * @Grid(
 ...
 * )
 */
class ResidentNotPrivatePayPaymentReceivedItem
{
    use TimeAwareTrait;
    use UserAwareTrait;
     ...
     *     "api_admin_resident_not_private_pay_payment_received_item_add",
     *     "api_admin_resident_not_private_pay_payment_received_item_edit"
     * })
     * @ORM\ManyToOne(targetEntity="App\Entity\ResidentLedger", inversedBy="residentNotPrivatePayPaymentReceivedItems")
     * @ORM\JoinColumns({
     ...
     * })
     * @ORM\ManyToOne(targetEntity="App\Entity\RpPaymentType", inversedBy="residentNotPrivatePayPaymentReceivedItems")
     * @ORM\JoinColumns({
     ...
     *     "api_admin_resident_ledger_edit"
     * })
     * @ORM\ManyToOne(targetEntity="App\Entity\ResidentRent", inversedBy="residentNotPrivatePayPaymentReceivedItems")
     * @ORM\JoinColumns({
