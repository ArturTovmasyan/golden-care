...
/**
 * Class ResidentPaymentReceivedItem
 *
 * @ORM\Entity(repositoryClass="App\Repository\ResidentPaymentReceivedItemRepository")
 * @ORM\Table(name="tbl_resident_payment_received_item")
 * @Grid(
...
class ResidentPaymentReceivedItem
{
     ...
     * })
     * @ORM\ManyToOne(targetEntity="App\Entity\ResidentLedger", inversedBy="residentPaymentReceivedItems")
     * @ORM\JoinColumns({
