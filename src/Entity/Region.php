 ...
 *              "id"         = "description",
 *              "type"       = "string",
 *              "field"      = "CONCAT(TRIM(SUBSTRING(r.description, 1, 100)), CASE WHEN LENGTH(r.description) > 100 THEN '…' ELSE '' END)"
 *          },
 *          {
 *              "id"         = "shorthand",
 *              "type"       = "string",
...
class Region
{
     ...
     *     "api_admin_region_edit"
     * })
     * @ORM\ManyToOne(targetEntity="App\Entity\Space", inversedBy="regions")
     * @ORM\JoinColumns({
