...
class Relationship
{
    const RELATIONSHIP_STATUS_DELETED = 1;
     ...
     * @Groups({"api_admin_relationship_list", "api_admin_relationship_get", "api_dashboard_relationship_list", "api_dashboard_relationship_get"})
     */
    private $id;
