 ...
 *              "id"         = "type_info",
 *              "type"       = "string",
 *              "field"      = "(CASE WHEN a.ownerType=1 THEN CONCAT('Lead: ', l.firstName, ' ', l.lastName) WHEN a.ownerType=2 AND rc.id IS NOT NULL THEN CONCAT('Referral: ', rc.firstName, ' ', rc.lastName) WHEN a.ownerType=2 AND rc.id IS NULL THEN CONCAT('Referral: ', ro.name) WHEN a.ownerType=3 THEN CONCAT('Organization: ', o.name) ELSE '' END)",
