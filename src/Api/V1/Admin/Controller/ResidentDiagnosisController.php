...
class ResidentDiagnosisController extends BaseController
{
    ...
    /**
     * @api {post} /api/v1.0/admin/resident/history/diagnose/related/info ResidentDiagnoses related info
     * @apiVersion 1.0.0
     * @apiName ResidentDiagnoses Related Info
     * @apiGroup Admin Resident Diagnoses
     * @apiDescription This function is used to get residentDiagnosis related info
     *
     * @apiHeader {String} Content-Type  application/x-www-form-urlencoded
     * @apiHeader {String} Authorization Bearer ACCESS_TOKEN
     *
